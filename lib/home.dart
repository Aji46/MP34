...
class HomescreenState extends State<Homescreen> {
  ...
  Widget build(BuildContext context) {
    LinearGradient myGradient = const LinearGradient(
      colors: [
        Color.fromRGBO(24, 151, 26, 1),
        Color.fromRGBO(0, 53, 152, 0.659),
        Color.fromRGBO(152, 0, 18, 0.612),
        Color.fromRGBO(0, 240, 224, 1)
      ],
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        selectedItemColor: const Color.fromARGB(255, 6, 194, 232),
